...
@section('content')
    ...
    <div class="banner-wrap" style="position: relative;">
        ...
        <div id="header-about">
            <h1 class="text-center p-0 m-0">
                YPAD™ Membership & Certification (Australia & New Zealand)
            </h1>
    ...
    <div class="container py-5">
        <div>
            ...
            <p class="text-center" style="font-size: 1.5em;">
                <strong>All pricing listed below is in AUD for Australia & New Zealand.</strong>
                <br><br>
    ...
    <div class="container py-5">
        ...
        <h2 class="text-center mb-4">Australia & New Zealand Membership Options</h2>
        <div class="row row-cols-1 row-cols-sm-1 row-cols-md-2 mt-5">
            <div>
                ...
                <div>
                    ...
                    <a href="https://yv686.infusionsoft.com/app/orderForms/YPAD-Studio-Membership---Australia-AUD" class="text-decoration-none rr-btn" target="_blank" style="width: 100%;">
                        <button class="rounded fw-bold px-2 py-2 shadow text-center" style="background: #067997; font-size: 0.9em; color: white; height: auto; width: 315px;">Become a YPAD™ Studio Member (AUD)</button>
                    </a>
                    <small class="text-muted ms-2">$139 AUD / mo</small>
                </div>
                <small>
                    <br>
...
{{--            </div>--}}
            ...
            <div class="accordion-item">
                ...
                <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                    <div class="accordion-body">
                        ...
                        <br><br>The studio owner membership costs $139 AUD per month with a 12-month commitment, and it will automatically renew. Certified studios and individuals are required to complete a yearly check-in to maintain their certification.
                        <br><br>Individual membership is available for $55 AUD per month with a 12-month commitment, and it will also automatically renew. Certified individuals must also complete a yearly check-in to ensure all requirements are met and up-to-date.
                    </div>
                </div>
            </div>
    ...
    <div class="container py-5">
        <p class="text-center mt-3">
            <a href="/membership-and-certification" class="text-muted">
                Viewing from Australia/NZ? Switch to USD version
            </a>
        </p>
    </div>
