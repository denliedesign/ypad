        ...
        <div class="row row-cols-sm-1 row-cols-md-2 row-cols-lg-2">
            ...
            <div class="d-flex align-items-center justify-content-center">
                <p class="m-0 p-0" style="font-size: 0.95em;">
                    YPAD™ was originally created as an instructional and certification program, as part of a non-profit called EDIFY Movement, and its acronym stood for Youth Protection Advocates in Dance®. It was founded by an amazing professional dancer, Leslie Scott Zanovitch, and a group of passionate advocates in 2012. In 2018, the founder and board asked longtime supporter and original YPAD™ Certified Studio owner Misty Lown to acquire the program as it was not sustainable in the non-profit model. Misty acquired and updated the course in 2019 to create easier access to training and certification options.
                    <br><br>
                    By 2022, the needs of the industry had changed. It was time for a stronger standard and fresh direction for YPAD™. With the help of seasoned dance, health, and safety professionals, the existing business and original courses were retired. A brand new YPAD™ was created. Instructional designers, writers, and researchers were engaged, and a new business was formed along with a new identity: Youth Protection Association for Dance™. This new name was chosen to reflect that YPAD™ is a group of people organized with a common purpose–to safeguard dancers and empower confident adults. By choosing to be here, you are choosing to be associated with this bold commitment.
                </p>
            </div>
        </div>
    </div>
