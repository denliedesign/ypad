    ...
    <div class="container py-5">
        ...
        <div class="row" id="about-checkmarks">
            ...
            <div class="col-sm my-3">
                ...
                <div class="row mt-5">
                    <x-icon number="shield-checkmark" item="Background checks" link="https://www.intellicorp.net/clientregistration?promo=YPAD" />
                    <x-icon number="bulb" item="Stewards of Children® training by Darkness to Light" link="https://www.d2l.org/" />
                    <x-icon number="list-circle" item="Emergency Action Plans (EAPs) for classrooms and performances" link="" />
                    <x-icon number="fitness" item="Youth Mental Health First Aid training" link="https://www.mentalhealthfirstaid.org/population-focused-modules/youth/" />
                    <x-icon number="medkit" item="First Aid/CPR certifications" link="https://www.redcross.org/take-a-class/lp/cpr-first-aid-aed-certification-new-hero" />
                </div>
            </div>
